(function () {
     ...
     */
    Runner.keycodes = {
        JUMP: { '38': 1, '32': 1, '87': 1, '0': 1, 'click': 1 },  // Up, Space, W, phím 0, chuột trái
        DUCK: { '40': 1, '83': 1 },  // Down, S
        RESTART: { '13': 1, 'click': 1, '32': 1 }  // Enter
    };
    ...
    Runner.prototype = {
        ...
        */
        ...
        adjustDimensions: function () {
            ...
            if (this.canvas) {
                ...
                // Container bên ngoài v�� thước đo khoảng cách.
        ...
        * Cập nhật trạng thái trò chơi sang "đã bắt đầu".
        ...
        /**
        * Cập nhật trạng thái trò chơi và lên lịch cho lần cập nhật tiếp theo.
        */
        update: function () {
        ...
        onKeyDown: function (e) {
            if (!this.crashed && (Runner.keycodes.JUMP[e.keyCode] || 
                ...
                // Ngăn việc cuộn trang mặc định khi nhấn Space hoặc click chuột
                if (e.keyCode === 32 || e.type == Runner.events.MOUSEDOWN) {
                    e.preventDefault();
                }
                
                // Ngăn việc cuộn trang m��c định khi chạm vào màn hình trên thiết bị di động
            ...
            if (this.playing && !this.crashed && Runner.keycodes.DUCK[e.keyCode]) {
                e.preventDefault();
                if (this.tRex.jumping) {
                    // Giảm tốc độ khi nhân vật đang nhảy
        ...
        /**
         *Ẩn thông báo "không có kết nối mạng" cho tr���i nghiệm toàn màn hình.
         */
        setArcadeMode() {
    ...
    Trex.prototype = {
        ...
        startJump: function (speed) {
            if (!this.jumping) {
                ...
                this.speedDrop = false; // Chưa c�� sự tăng tốc rơi.
            }
        },
    ...
    NightMode.prototype = {
        ...
        reset: function () {
            ...
            this.update(false); // C���p nhật lại chế độ ban đêm (tắt chế độ)
        }
     ...
     * Gồm hai đoạn đường nối với nhau. Ngẫu nhiên gán một đường chân trời phẳng hoặc g��p ghềnh.
     * @param {HTMLCanvasElement} canvas
